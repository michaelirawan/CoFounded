            ...
            <div class="span12">
                <p style="text-align: center; margin-top: 40px">
                    <a href="#" class="button active">
                        <span class="title">Software/Internet</span>
                    </a>
                    <a href="#" class="button">
                        <span class="title">Comp/Electronics</span>
                    </a>
                    <a href="#" class="button">
                ...
                <p style="text-align: center;margin-top: 40px">
                    ...
                    <a href="#" class="button">
                        <span class="title">Food & baverage</span>
                    </a>
                    <a href="#" class="button">
                        <span class="title">Music/Entertainment</span>
                    </a>
                </p>
            </div>
        </div>
